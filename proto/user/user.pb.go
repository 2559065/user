...
type UserRegisterRequest struct {
	...
	Id        int64  `protobuf:"varint,4,opt,name=id,proto3" json:"id,omitempty"` //... 其它信息
}
...
func (x *UserRegisterRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x2e, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x49,
	...
	0x22, 0x73, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x52, 0x03, 0x70, 0x77, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x30, 0x0a, 0x14, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67,
	...
	0x03, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x43, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79, 0x49, 0x64, 0x12, 0x0c, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x1a, 0x16, 0x2e, 0x75, 0x73, 0x65, 0x72,
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x1a, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73,
...
var file_proto_user_user_proto_depIdxs = []int32{
	3, // 0: user.User.Register:input_type -> user.UserRegisterRequest
	5, // 1: user.User.Login:input_type -> user.UserLoginRequest
	1, // 2: user.User.GetUserInfo:input_type -> user.UserInfoRequest
	0, // 3: user.User.GetUserInfoById:input_type -> user.UserId
	3, // 4: user.User.UpdateUserInfo:input_type -> user.UserRegisterRequest
	0, // 5: user.User.DeleteUser:input_type -> user.UserId
	4, // 6: user.User.Register:output_type -> user.UserRegisterResponse
	6, // 7: user.User.Login:output_type -> user.UserLoginResponse
	2, // 8: user.User.GetUserInfo:output_type -> user.UserInfoResponse
	2, // 9: user.User.GetUserInfoById:output_type -> user.UserInfoResponse
	2, // 10: user.User.UpdateUserInfo:output_type -> user.UserInfoResponse
	4, // 11: user.User.DeleteUser:output_type -> user.UserRegisterResponse
